...
var TextLayerBuilder = function () {
  ...
  _createClass(TextLayerBuilder, [{
    ...
    value: function renderMatches(matches) {
      ...
      var highlightAll = true; //this.findController === null ? true : this.findController.state.highlightAll;
      var infinity = {
        divIdx: -1,
        offset: undefined
      };
    ...
    key: 'updateMatches',
    value: function updateMatches(offsetTinkered=[]) {
      ...
      // console.log('offsetTinkered', offsetTinkered)  
  ...
  _createClass(PDFFindController, [{
    ...
    value: function updatePage(index) {
      ...
      if (page.textLayer) {
        ...
        // console.log(index, offsetTinkered)
        page.textLayer.updateMatches(offsetTinkered)
      }
    }
  }, {
    key: 'nextMatch',
    value: function nextMatch() {
      ...
      var currentPageIndexTinkered = this.state.currentPageIndexTinkered
      this.active = true;
      if (this.dirtyMatch) {
        this.dirtyMatch = false;
