...
var TextLayerBuilder = function () {
  ...
  _createClass(TextLayerBuilder, [{
    ...
    value: function renderMatches(matches) {
      ...
      var highlightAll = true; //this.findController === null ? false : this.findController.state.highlightAll;
      var infinity = {
        divIdx: -1,
        offset: undefined
      };
    ...
    value: function updateMatches() {
      ...
      var offsetArrayTinkered = this.findController.state ? this.findController.state.offsetArrayTinkered : []; 
      var index = this.pageIdx; 
      var offsetTinkered = offsetArrayTinkered ? offsetArrayTinkered.filter(obj => obj.pageIndex===index) : [];
      var offsetTinkered = offsetArrayTinkered.filter(obj => obj.pageIndex===index);
      // console.log('offsetTinkered1', offsetArrayTinkered,  index, offsetTinkered)    
      ...
      this.renderMatches(offsetTinkered);
    }
  }, {
    key: '_bindMouse',
...
var DefaultTextLayerFactory = function () {
  ...
  _createClass(DefaultTextLayerFactory, [{
    ...
    value: function createTextLayerBuilder(textLayerDiv, pageIndex, viewport) {
      var enhanceTextSelection = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  ...
  _createClass(BaseViewer, [{
    ...
    value: function _setScale(value) {
      ...
      if (scale > 0) {
        ...
        var pageWidthScale = (this.container.clientWidth - hPadding) / Math.max(currentPage.width,currentPage.height) * currentPage.scale;        
        var pageHeightScale = (this.container.clientHeight - vPadding) / currentPage.height * currentPage.scale;       
        // console.log('width', this.container.clientWidth, hPadding, currentPage.width, pageWidthScale)
    ...
    value: function _resetCurrentPageView() {
      ...
      if (pageView !== undefined) { this._scrollIntoView({ pageDiv: pageView.div }) };
    }
  }, {
...
var PDFFindController = function () {
  ...
  _createClass(PDFFindController, [{
    ...
    value: function updatePage(index) {
      ...
      if (page.textLayer) {
        var offsetArrayTinkered = this.state.offsetArrayTinkered;
    ...
    value: function _ensurePageViewVisible() {
      ...
      switch (viewerNodes.length) {
        ...
        case 1:
          ...
          if (pageView !== undefined) {  this.viewer.appendChild(pageView.div) };
