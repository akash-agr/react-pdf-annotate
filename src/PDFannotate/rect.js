 ...
 * @param {Event} e The DOM event to handle
 */
export function handleDocumentMouseup(e) {
 ...
 * @param {Event} e The DOM event to handle
 */
export function handleDocumentKeyup(e) {
...
export function enableRect(type) {
  ...
  document.addEventListener("mousedown", handleDocumentMousedown); // Will not work for underline/strikeout
